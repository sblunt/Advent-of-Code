...
for ltr in antenna_coords.keys():
    ...
    for combo in matching_node_combos:
        ...
        while (
            ...
            antinode_row1 -= rowdiff
            antinode_col1 -= coldiff
        while (
            antinode_row2 >= 0
            and antinode_col2 >= 0
            and antinode_row2 <= i
            ...
            antinode_row2 += rowdiff
            antinode_col2 += coldiff

    # also count antinodes at locations of nodes themselves
    for node in node_locations:
        antinode_locations[node[0], node[1]] = 1
